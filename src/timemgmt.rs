...
pub const WEAK_FORCED_TM_FRAC: u32 = 601;
pub const DEFAULT_MOVES_TO_GO: u32 = 27;
pub const HARD_WINDOW_FRAC: u32 = 58;
pub const OPTIMAL_WINDOW_FRAC: u32 = 61;
pub const INCREMENT_FRAC: u32 = 92;
pub const NODE_TM_SUBTREE_MULTIPLIER: u32 = 159;
pub const FAIL_LOW_TM_BONUS: u32 = 244;
