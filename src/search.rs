...
const ASPIRATION_EVAL_DIVISOR: i32 = 31055;
const DELTA_BASE_MUL: i32 = 45;
const DELTA_REDUCTION_MUL: i32 = 17;
const RFP_MARGIN: i32 = 66;
const RFP_IMPROVING_MARGIN: i32 = 75;
const NMP_IMPROVING_MARGIN: i32 = 138;
const NMP_DEPTH_MUL: i32 = -4;
const NMP_REDUCTION_EVAL_DIVISOR: i32 = 173;
const SEE_QUIET_MARGIN: i32 = -62;
const SEE_TACTICAL_MARGIN: i32 = -27;
const FUTILITY_COEFF_0: i32 = 84;
const FUTILITY_COEFF_1: i32 = 73;
const RAZORING_COEFF_0: i32 = 124;
const RAZORING_COEFF_1: i32 = 304;
const DOUBLE_EXTENSION_MARGIN: i32 = 12;
const TRIPLE_EXTENSION_MARGIN: i32 = 204;
const LMR_BASE: f64 = 97.0;
const LMR_DIVISION: f64 = 268.0;
const PROBCUT_MARGIN: i32 = 182;
const PROBCUT_IMPROVING_MARGIN: i32 = 78;
const PROBCUT_EVAL_DIV: i32 = 292;
const HISTORY_LMR_DIVISOR: i32 = 16793;
const QS_SEE_BOUND: i32 = -133;
const MAIN_SEE_BOUND: i32 = -103;
const DO_DEEPER_BASE_MARGIN: i32 = 30;
const DO_DEEPER_DEPTH_MARGIN: i32 = 7;
const DO_SHALLOWER_MARGIN: i32 = 17;
const HISTORY_PRUNING_MARGIN: i32 = -3302;
const QS_FUTILITY: i32 = 335;
const SEE_STAT_SCORE_MUL: i32 = 24;
const LMR_REFUTATION_MUL: i32 = 848;
const LMR_NON_PV_MUL: i32 = 1022;
const LMR_TTPV_MUL: i32 = 1291;
const LMR_TTPV_FAIL_LOW_MUL: i32 = 1160;
const LMR_CUT_NODE_MUL: i32 = 1623;
const LMR_NON_IMPROVING_MUL: i32 = 610;
const LMR_TT_CAPTURE_MUL: i32 = 981;
const LMR_CHECK_MUL: i32 = 1396;
const LMR_CORR_MUL: i32 = 422;
const LMR_ALPHA_RAISE_MUL: i32 = 333;
const LMR_BASE_OFFSET: i32 = 214;
const TTPV_LMR_DEPTH_MUL: i32 = 783;
const MAIN_HISTORY: HistoryConfig = HistoryConfig::new(341, 221, 2294, 127, 558, 974);
const CONT1_HISTORY: HistoryConfig = HistoryConfig::new(285, 145, 3910, 238, 282, 1359);
const CONT2_HISTORY: HistoryConfig = HistoryConfig::new(187, 204, 1720, 277, 82, 1079);
const CONT4_HISTORY: HistoryConfig = HistoryConfig::new(171, 192, 1525, 197, -39, 1012);
const PAWN_HISTORY: HistoryConfig = HistoryConfig::new(145, 145, 2112, 245, 167, 1273);
const TACTICAL_HISTORY: HistoryConfig = HistoryConfig::new(90, 361, 1267, 24, 374, 1393);
const MAIN_STAT_SCORE_MUL: i32 = 28;
const CONT1_STAT_SCORE_MUL: i32 = 39;
const CONT2_STAT_SCORE_MUL: i32 = 34;
const CONT4_STAT_SCORE_MUL: i32 = 15;
const TACT_STAT_SCORE_MUL: i32 = 43;
const PAWN_CORRHIST_WEIGHT: i32 = 1925;
const MAJOR_CORRHIST_WEIGHT: i32 = 1516;
const MINOR_CORRHIST_WEIGHT: i32 = 1413;
const NONPAWN_CORRHIST_WEIGHT: i32 = 1839;
const CONTINUATION_12_CORRHIST_WEIGHT: i32 = 1929;
const CONTINUATION_14_CORRHIST_WEIGHT: i32 = 1863;
const EVAL_POLICY_IMPROVEMENT_SCALE: i32 = 223;
const EVAL_POLICY_OFFSET: i32 = -11;
const HINDSIGHT_EXT_DEPTH: i32 = 1549;
const HINDSIGHT_RED_DEPTH: i32 = 2482;
const HINDSIGHT_RED_EVAL: i32 = 125;
const OPTIMISM_OFFSET: i32 = 185;
const OPTIMISM_MATERIAL_BASE: i32 = 1784;
const EVAL_POLICY_UPDATE_MAX: i32 = 92;
const PROBCUT_SEE_SCALE: i32 = 258;
const PROBCUT_ADA_OFFSET: i32 = 49;
const PROBCUT_ADA_DIV: i32 = 296;
