...
const CONT3_HISTORY: HistoryConfig = HistoryConfig::new(80, 200, 1615, 100, 50, 950);
const CONT4_HISTORY: HistoryConfig = HistoryConfig::new(180, 200, 1630, 200, 50, 950);
const CONT5_HISTORY: HistoryConfig = HistoryConfig::new(80, 200, 1645, 100, 50, 950);
const CONT6_HISTORY: HistoryConfig = HistoryConfig::new(130, 200, 1660, 150, 50, 950);
...
const CONT3_STAT_SCORE_MUL: i32 = 4;
const CONT4_STAT_SCORE_MUL: i32 = 13;
const CONT5_STAT_SCORE_MUL: i32 = 4;
const CONT6_STAT_SCORE_MUL: i32 = 10;
