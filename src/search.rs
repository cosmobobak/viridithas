...
const MAIN_HISTORY: HistoryConfig = HistoryConfig::new(390, 250, 2400, 140, 700, 1100);
const SLOW_HISTORY: HistoryConfig = HistoryConfig::new(330, 200, 2000, 80, 300, 700);
...
const MAIN_STAT_SCORE_MUL: i32 = 20;
const SLOW_STAT_SCORE_MUL: i32 = 16;
