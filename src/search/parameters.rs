...
use crate::{
    ...
    search::{
        ...
        LMR_BASE, LMR_CHECK_MUL, LMR_COMPLEXITY_DIVISOR, LMR_CUT_NODE_MUL, LMR_DIVISION,
...
pub struct Config {
    ...
    pub lmr_complexity_divisor: i32,
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            lmr_complexity_divisor: LMR_COMPLEXITY_DIVISOR,
...
impl Config {
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            LMR_COMPLEXITY_DIVISOR = [self.lmr_complexity_divisor],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            LMR_COMPLEXITY_DIVISOR = [self.lmr_complexity_divisor, 1, 1024, 16],
