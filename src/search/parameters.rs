...
use crate::{
    ...
    search::{
        ...
        LMR_REFUTATION_MUL, LMR_SEXT_MUL, LMR_TT_CAPTURE_MUL, LMR_TTPV_FAIL_LOW_MUL, LMR_TTPV_MUL,
        MAIN_HISTORY, MAIN_SEE_BOUND, MAIN_STAT_SCORE_MUL, MAJOR_CORRHIST_WEIGHT,
        ...
        QUIET_CHECK_SEE_MARGIN, RAZORING_COEFF_0, RAZORING_COEFF_1, RFP_IMPROVING_MARGIN,
        RFP_MARGIN, SEE_QUIET_MARGIN, SEE_STAT_SCORE_MUL, SEE_TACTICAL_MARGIN, TACT_STAT_SCORE_MUL,
        TACTICAL_HISTORY, TRIPLE_EXTENSION_MARGIN, TTPV_LMR_DEPTH_MUL,
    },
    timemgmt::{
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            lmr_ttpv_fail_low_mul: LMR_TTPV_FAIL_LOW_MUL,
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            LMR_TTPV_FAIL_LOW_MUL = [self.lmr_ttpv_fail_low_mul],
            ...
            LMR_SEXT_MUL = [self.lmr_sext_mul]
        ]
    }
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            LMR_TTPV_FAIL_LOW_MUL = [self.lmr_ttpv_fail_low_mul, 1, 4096, 96],
            ...
            LMR_SEXT_MUL = [self.lmr_sext_mul, -4096, 4096, 96]
        ]
    }
