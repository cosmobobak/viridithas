...
use crate::{
    ...
    search::{
        ...
        CONT2_STAT_SCORE_MUL, CONT3_HISTORY, CONT3_STAT_SCORE_MUL, CONT4_HISTORY,
        CONT4_STAT_SCORE_MUL, CONT5_HISTORY, CONT5_STAT_SCORE_MUL, CONT6_HISTORY,
        CONT6_STAT_SCORE_MUL, CONTINUATION_CORRHIST_WEIGHT, DELTA_BASE_MUL, DELTA_INITIAL,
        ...
        LMR_TTPV_MUL, MAIN_HISTORY, MAIN_SEE_BOUND, MAIN_STAT_SCORE_MUL, MAJOR_CORRHIST_WEIGHT,
        MINOR_CORRHIST_WEIGHT, NMP_DEPTH_MUL, NMP_IMPROVING_MARGIN, NMP_REDUCTION_EVAL_DIVISOR,
        NONPAWN_CORRHIST_WEIGHT, OPTIMISM_MATERIAL_BASE, OPTIMISM_OFFSET, PAWN_CORRHIST_WEIGHT,
        PAWN_HISTORY, PROBCUT_ADA_DIV, PROBCUT_ADA_OFFSET, PROBCUT_EVAL_DIV,
        PROBCUT_IMPROVING_MARGIN, PROBCUT_MARGIN, PROBCUT_SEE_SCALE, QS_FUTILITY, QS_SEE_BOUND,
...
pub struct HistoryConfig {
    pub bonus_mul: i32,
    pub bonus_offset: i32,
    pub bonus_max: i32,
    pub malus_mul: i32,
    pub malus_offset: i32,
    pub malus_max: i32,
}
...
pub struct Config {
    ...
    pub cont3_history: HistoryConfig,
    pub cont4_history: HistoryConfig,
    pub cont5_history: HistoryConfig,
    pub cont6_history: HistoryConfig,
    pub pawn_history: HistoryConfig,
    pub tactical_history: HistoryConfig,
    pub main_stat_score_mul: i32,
    pub cont1_stat_score_mul: i32,
    pub cont2_stat_score_mul: i32,
    pub cont3_stat_score_mul: i32,
    pub cont4_stat_score_mul: i32,
    pub cont5_stat_score_mul: i32,
    pub cont6_stat_score_mul: i32,
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            cont3_history: CONT3_HISTORY,
            cont4_history: CONT4_HISTORY,
            cont5_history: CONT5_HISTORY,
            cont6_history: CONT6_HISTORY,
            pawn_history: PAWN_HISTORY,
            tactical_history: TACTICAL_HISTORY,
            ...
            cont3_stat_score_mul: CONT3_STAT_SCORE_MUL,
            cont4_stat_score_mul: CONT4_STAT_SCORE_MUL,
            cont5_stat_score_mul: CONT5_STAT_SCORE_MUL,
            cont6_stat_score_mul: CONT6_STAT_SCORE_MUL,
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            MAIN_HISTORY_MALUS_MUL = [self.main_history.malus_mul],
            MAIN_HISTORY_MALUS_OFFSET = [self.main_history.malus_offset],
            MAIN_HISTORY_MALUS_MAX = [self.main_history.malus_max],
            CONT1_HISTORY_BONUS_MUL = [self.cont1_history.bonus_mul],
            CONT1_HISTORY_BONUS_OFFSET = [self.cont1_history.bonus_offset],
            CONT1_HISTORY_BONUS_MAX = [self.cont1_history.bonus_max],
            CONT1_HISTORY_MALUS_MUL = [self.cont1_history.malus_mul],
            CONT1_HISTORY_MALUS_OFFSET = [self.cont1_history.malus_offset],
            CONT1_HISTORY_MALUS_MAX = [self.cont1_history.malus_max],
            CONT2_HISTORY_BONUS_MUL = [self.cont2_history.bonus_mul],
            CONT2_HISTORY_BONUS_OFFSET = [self.cont2_history.bonus_offset],
            CONT2_HISTORY_BONUS_MAX = [self.cont2_history.bonus_max],
            CONT2_HISTORY_MALUS_MUL = [self.cont2_history.malus_mul],
            CONT2_HISTORY_MALUS_OFFSET = [self.cont2_history.malus_offset],
            CONT2_HISTORY_MALUS_MAX = [self.cont2_history.malus_max],
            CONT3_HISTORY_BONUS_MUL = [self.cont3_history.bonus_mul],
            CONT3_HISTORY_BONUS_OFFSET = [self.cont3_history.bonus_offset],
            CONT3_HISTORY_BONUS_MAX = [self.cont3_history.bonus_max],
            CONT3_HISTORY_MALUS_MUL = [self.cont3_history.malus_mul],
            CONT3_HISTORY_MALUS_OFFSET = [self.cont3_history.malus_offset],
            CONT3_HISTORY_MALUS_MAX = [self.cont3_history.malus_max],
            CONT4_HISTORY_BONUS_MUL = [self.cont4_history.bonus_mul],
            CONT4_HISTORY_BONUS_OFFSET = [self.cont4_history.bonus_offset],
            CONT4_HISTORY_BONUS_MAX = [self.cont4_history.bonus_max],
            CONT4_HISTORY_MALUS_MUL = [self.cont4_history.malus_mul],
            CONT4_HISTORY_MALUS_OFFSET = [self.cont4_history.malus_offset],
            CONT4_HISTORY_MALUS_MAX = [self.cont4_history.malus_max],
            CONT5_HISTORY_BONUS_MUL = [self.cont5_history.bonus_mul],
            CONT5_HISTORY_BONUS_OFFSET = [self.cont5_history.bonus_offset],
            CONT5_HISTORY_BONUS_MAX = [self.cont5_history.bonus_max],
            CONT5_HISTORY_MALUS_MUL = [self.cont5_history.malus_mul],
            CONT5_HISTORY_MALUS_OFFSET = [self.cont5_history.malus_offset],
            CONT5_HISTORY_MALUS_MAX = [self.cont5_history.malus_max],
            CONT6_HISTORY_BONUS_MUL = [self.cont6_history.bonus_mul],
            CONT6_HISTORY_BONUS_OFFSET = [self.cont6_history.bonus_offset],
            CONT6_HISTORY_BONUS_MAX = [self.cont6_history.bonus_max],
            CONT6_HISTORY_MALUS_MUL = [self.cont6_history.malus_mul],
            CONT6_HISTORY_MALUS_OFFSET = [self.cont6_history.malus_offset],
            CONT6_HISTORY_MALUS_MAX = [self.cont6_history.malus_max],
            PAWN_HISTORY_BONUS_MUL = [self.pawn_history.bonus_mul],
            PAWN_HISTORY_BONUS_OFFSET = [self.pawn_history.bonus_offset],
            PAWN_HISTORY_BONUS_MAX = [self.pawn_history.bonus_max],
            PAWN_HISTORY_MALUS_MUL = [self.pawn_history.malus_mul],
            PAWN_HISTORY_MALUS_OFFSET = [self.pawn_history.malus_offset],
            PAWN_HISTORY_MALUS_MAX = [self.pawn_history.malus_max],
            TACTICAL_HISTORY_BONUS_MUL = [self.tactical_history.bonus_mul],
            TACTICAL_HISTORY_BONUS_OFFSET = [self.tactical_history.bonus_offset],
            TACTICAL_HISTORY_BONUS_MAX = [self.tactical_history.bonus_max],
            TACTICAL_HISTORY_MALUS_MUL = [self.tactical_history.malus_mul],
            TACTICAL_HISTORY_MALUS_OFFSET = [self.tactical_history.malus_offset],
            TACTICAL_HISTORY_MALUS_MAX = [self.tactical_history.malus_max],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            MAIN_HISTORY_MALUS_MUL = [self.main_history.malus_mul, 1, 1536, 32],
            MAIN_HISTORY_MALUS_OFFSET = [self.main_history.malus_offset, -1024, 1024, 64],
            MAIN_HISTORY_MALUS_MAX = [self.main_history.malus_max, 1, 4096, 256],
            CONT1_HISTORY_BONUS_MUL = [self.cont1_history.bonus_mul, 1, 1536, 32],
            CONT1_HISTORY_BONUS_OFFSET = [self.cont1_history.bonus_offset, -1024, 1024, 64],
            CONT1_HISTORY_BONUS_MAX = [self.cont1_history.bonus_max, 1, 4096, 256],
            CONT1_HISTORY_MALUS_MUL = [self.cont1_history.malus_mul, 1, 1536, 32],
            CONT1_HISTORY_MALUS_OFFSET = [self.cont1_history.malus_offset, -1024, 1024, 64],
            CONT1_HISTORY_MALUS_MAX = [self.cont1_history.malus_max, 1, 4096, 256],
            CONT2_HISTORY_BONUS_MUL = [self.cont2_history.bonus_mul, 1, 1536, 32],
            CONT2_HISTORY_BONUS_OFFSET = [self.cont2_history.bonus_offset, -1024, 1024, 64],
            CONT2_HISTORY_BONUS_MAX = [self.cont2_history.bonus_max, 1, 4096, 256],
            CONT2_HISTORY_MALUS_MUL = [self.cont2_history.malus_mul, 1, 1536, 32],
            CONT2_HISTORY_MALUS_OFFSET = [self.cont2_history.malus_offset, -1024, 1024, 64],
            CONT2_HISTORY_MALUS_MAX = [self.cont2_history.malus_max, 1, 4096, 256],
            CONT3_HISTORY_BONUS_MUL = [self.cont3_history.bonus_mul, 1, 1536, 32],
            CONT3_HISTORY_BONUS_OFFSET = [self.cont3_history.bonus_offset, -1024, 1024, 64],
            CONT3_HISTORY_BONUS_MAX = [self.cont3_history.bonus_max, 1, 4096, 256],
            CONT3_HISTORY_MALUS_MUL = [self.cont3_history.malus_mul, 1, 1536, 32],
            CONT3_HISTORY_MALUS_OFFSET = [self.cont3_history.malus_offset, -1024, 1024, 64],
            CONT3_HISTORY_MALUS_MAX = [self.cont3_history.malus_max, 1, 4096, 256],
            CONT4_HISTORY_BONUS_MUL = [self.cont4_history.bonus_mul, 1, 1536, 32],
            CONT4_HISTORY_BONUS_OFFSET = [self.cont4_history.bonus_offset, -1024, 1024, 64],
            CONT4_HISTORY_BONUS_MAX = [self.cont4_history.bonus_max, 1, 4096, 256],
            CONT4_HISTORY_MALUS_MUL = [self.cont4_history.malus_mul, 1, 1536, 32],
            CONT4_HISTORY_MALUS_OFFSET = [self.cont4_history.malus_offset, -1024, 1024, 64],
            CONT4_HISTORY_MALUS_MAX = [self.cont4_history.malus_max, 1, 4096, 256],
            CONT5_HISTORY_BONUS_MUL = [self.cont5_history.bonus_mul, 1, 1536, 32],
            CONT5_HISTORY_BONUS_OFFSET = [self.cont5_history.bonus_offset, -1024, 1024, 64],
            CONT5_HISTORY_BONUS_MAX = [self.cont5_history.bonus_max, 1, 4096, 256],
            CONT5_HISTORY_MALUS_MUL = [self.cont5_history.malus_mul, 1, 1536, 32],
            CONT5_HISTORY_MALUS_OFFSET = [self.cont5_history.malus_offset, -1024, 1024, 64],
            CONT5_HISTORY_MALUS_MAX = [self.cont5_history.malus_max, 1, 4096, 256],
            CONT6_HISTORY_BONUS_MUL = [self.cont6_history.bonus_mul, 1, 1536, 32],
            CONT6_HISTORY_BONUS_OFFSET = [self.cont6_history.bonus_offset, -1024, 1024, 64],
            CONT6_HISTORY_BONUS_MAX = [self.cont6_history.bonus_max, 1, 4096, 256],
            CONT6_HISTORY_MALUS_MUL = [self.cont6_history.malus_mul, 1, 1536, 32],
            CONT6_HISTORY_MALUS_OFFSET = [self.cont6_history.malus_offset, -1024, 1024, 64],
            CONT6_HISTORY_MALUS_MAX = [self.cont6_history.malus_max, 1, 4096, 256],
            PAWN_HISTORY_BONUS_MUL = [self.pawn_history.bonus_mul, 1, 1536, 32],
            PAWN_HISTORY_BONUS_OFFSET = [self.pawn_history.bonus_offset, -1024, 1024, 64],
            PAWN_HISTORY_BONUS_MAX = [self.pawn_history.bonus_max, 1, 4096, 256],
            PAWN_HISTORY_MALUS_MUL = [self.pawn_history.malus_mul, 1, 1536, 32],
            PAWN_HISTORY_MALUS_OFFSET = [self.pawn_history.malus_offset, -1024, 1024, 64],
            PAWN_HISTORY_MALUS_MAX = [self.pawn_history.malus_max, 1, 4096, 256],
            TACTICAL_HISTORY_BONUS_MUL = [self.tactical_history.bonus_mul, 1, 1536, 32],
            TACTICAL_HISTORY_BONUS_OFFSET = [self.tactical_history.bonus_offset, -1024, 1024, 64],
            TACTICAL_HISTORY_BONUS_MAX = [self.tactical_history.bonus_max, 1, 4096, 256],
            TACTICAL_HISTORY_MALUS_MUL = [self.tactical_history.malus_mul, 1, 1536, 32],
            TACTICAL_HISTORY_MALUS_OFFSET = [self.tactical_history.malus_offset, -1024, 1024, 64],
            TACTICAL_HISTORY_MALUS_MAX = [self.tactical_history.malus_max, 1, 4096, 256],
