...
use crate::{
    ...
    search::{
        ...
        LMR_TT_OBVIOUS_CAPTURE_MUL, LMR_TTPV_MUL, MAIN_HISTORY_BONUS_MAX, MAIN_HISTORY_BONUS_MUL,
        MAIN_HISTORY_BONUS_OFFSET, MAIN_HISTORY_MALUS_MAX, MAIN_HISTORY_MALUS_MUL,
        MAIN_HISTORY_MALUS_OFFSET, MAIN_SEE_BOUND, MAIN_STAT_SCORE_MUL, MAJOR_CORRHIST_WEIGHT,
        ...
        PAWN_HISTORY_BONUS_MAX, PAWN_HISTORY_BONUS_MUL, PAWN_HISTORY_BONUS_OFFSET,
        PAWN_HISTORY_MALUS_MAX, PAWN_HISTORY_MALUS_MUL, PAWN_HISTORY_MALUS_OFFSET, PROBCUT_ADA_DIV,
        PROBCUT_ADA_OFFSET, PROBCUT_EVAL_DIV, PROBCUT_IMPROVING_MARGIN, PROBCUT_MARGIN,
        ...
        SEE_TACTICAL_MARGIN, TACT_STAT_SCORE_MUL, TACTICAL_HISTORY_BONUS_MAX,
...
pub struct Config {
    ...
    pub lmr_tt_obvious_capture_mul: i32,
...
impl Config {
    ...
    pub const fn default() -> Self {
        Self {
            ...
            lmr_tt_obvious_capture_mul: LMR_TT_OBVIOUS_CAPTURE_MUL,
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            LMR_TT_OBVIOUS_CAPTURE_MUL = [self.lmr_tt_obvious_capture_mul],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            LMR_TT_OBVIOUS_CAPTURE_MUL = [self.lmr_tt_obvious_capture_mul, 1, 4096, 96],
