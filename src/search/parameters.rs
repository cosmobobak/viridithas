...
use crate::{
    ...
    search::{
        ...
        SEE_QUIET_MARGIN, SEE_STAT_SCORE_MUL, SEE_TACTICAL_MARGIN, SLOW_HISTORY,
        SLOW_STAT_SCORE_MUL, TACT_STAT_SCORE_MUL, TACTICAL_HISTORY, TRIPLE_EXTENSION_MARGIN,
    },
    timemgmt::{
...
pub struct Config {
    ...
    pub slow_history: HistoryConfig,
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            slow_stat_score_mul: SLOW_STAT_SCORE_MUL,
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            SLOW_HISTORY_BONUS_MUL = [self.slow_history.bonus_mul],
            SLOW_HISTORY_BONUS_OFFSET = [self.slow_history.bonus_offset],
            SLOW_HISTORY_BONUS_MAX = [self.slow_history.bonus_max],
            SLOW_HISTORY_MALUS_MUL = [self.slow_history.malus_mul],
            SLOW_HISTORY_MALUS_OFFSET = [self.slow_history.malus_offset],
            SLOW_HISTORY_MALUS_MAX = [self.slow_history.malus_max],
            ...
            SLOW_STAT_SCORE_MUL = [self.slow_stat_score_mul],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            SLOW_HISTORY_BONUS_MUL = [self.slow_history.bonus_mul, 1, 1536, 32],
            SLOW_HISTORY_BONUS_OFFSET = [self.slow_history.bonus_offset, -1024, 1024, 64],
            SLOW_HISTORY_BONUS_MAX = [self.slow_history.bonus_max, 1, 4096, 256],
            SLOW_HISTORY_MALUS_MUL = [self.slow_history.malus_mul, 1, 1536, 32],
            SLOW_HISTORY_MALUS_OFFSET = [self.slow_history.malus_offset, -1024, 1024, 64],
            SLOW_HISTORY_MALUS_MAX = [self.slow_history.malus_max, 1, 4096, 256],
            ...
            SLOW_STAT_SCORE_MUL = [self.slow_stat_score_mul, 1, 128, 8],
