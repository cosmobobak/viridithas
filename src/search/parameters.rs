...
use crate::{
    ...
    search::{
        ...
        CONT2_HISTORY_MALUS_OFFSET, CONT4_HISTORY_BONUS_MAX, CONT4_HISTORY_BONUS_MUL,
        CONT4_HISTORY_BONUS_OFFSET, CONT4_HISTORY_MALUS_MAX, CONT4_HISTORY_MALUS_MUL,
        CONT4_HISTORY_MALUS_OFFSET, DOUBLE_EXTENSION_MARGIN, DO_DEEPER_BASE_MARGIN,
        ...
        LMR_BASE, LMR_CHECK_MUL, LMR_CUT_NODE_MUL, LMR_DIVISION, LMR_NON_IMPROVING_MUL,
        LMR_NON_PV_MUL, LMR_REFUTATION_MUL, LMR_TTPV_MUL, LMR_TT_CAPTURE_MUL,
...
impl Config {
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            MAIN_HISTORY_BONUS_MUL = [self.main_history_bonus_mul, 1, 1500, 32],
            ...
            CONT1_HISTORY_MALUS_MUL = [self.cont1_history_malus_mul, 1, 1500, 32],
            ...
            CONT2_HISTORY_BONUS_MUL = [self.cont2_history_bonus_mul, 1, 1500, 32],
            ...
            CONT2_HISTORY_MALUS_MUL = [self.cont2_history_malus_mul, 1, 1500, 32],
            ...
            TACTICAL_HISTORY_BONUS_MUL = [self.tactical_history_bonus_mul, 1, 1500, 32],
            ...
            TACTICAL_HISTORY_MALUS_MUL = [self.tactical_history_malus_mul, 1, 1500, 32],
