...
use crate::{
    ...
    search::{
        ...
        DO_DEEPER_BASE_MARGIN, DO_DEEPER_DEPTH_MARGIN, DO_EVEN_DEEPER_MARGIN, DO_SHALLOWER_MARGIN,
        ...
        LMR_CUT_NODE_MUL, LMR_DIVISION,
        LMR_NON_IMPROVING_MUL, LMR_NON_PV_MUL, LMR_REFUTATION_MUL, LMR_TT_CAPTURE_MUL,
        LMR_TTPV_FAIL_LOW_MUL, LMR_TTPV_MUL, MAIN_HISTORY, MAIN_SEE_BOUND, MAIN_STAT_SCORE_MUL, MAJOR_CORRHIST_WEIGHT,
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            do_even_deeper_margin: DO_EVEN_DEEPER_MARGIN,
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            DO_EVEN_DEEPER_MARGIN = [self.do_even_deeper_margin],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            DO_EVEN_DEEPER_MARGIN = [self.do_even_deeper_margin, 1, 1024, 20],
