...
use crate::{
    ...
    search::{
        ...
        LMR_CUT_NODE_MUL, LMR_CUTOFF_CNT_MUL, LMR_DIVISION, LMR_NON_IMPROVING_MUL, LMR_NON_PV_MUL,
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            lmr_cutoff_cnt_mul: LMR_CUTOFF_CNT_MUL,
        }
    }
}
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            LMR_CUTOFF_CNT_MUL = [self.lmr_cutoff_cnt_mul]
        ]
    }
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            LMR_CUTOFF_CNT_MUL = [self.lmr_cutoff_cnt_mul, 0, 2560, 120]
        ]
    }
