...
use crate::{
    ...
    search::{
        ...
        RAZORING_COEFF_1, RAZORING_COEFF_2, RFP_IMPROVING_MARGIN, RFP_MARGIN, SEE_QUIET_MARGIN,
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            razoring_coeff_2: RAZORING_COEFF_2,
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            RAZORING_COEFF_2 = [self.razoring_coeff_2],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            RAZORING_COEFF_2 = [self.razoring_coeff_2, 0, 256, 8],
