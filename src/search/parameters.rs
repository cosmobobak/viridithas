...
use crate::{
    ...
    search::{
        ...
        LMR_BASE, LMR_CHECK_MUL, LMR_COMPLEXITY_MUL, LMR_CUT_NODE_MUL, LMR_DIVISION,
...
impl Config {
    pub const fn default() -> Self {
        Self {
            ...
            lmr_complexity_mul: LMR_COMPLEXITY_MUL,
...
impl Config {
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            LMR_COMPLEXITY_MUL = [self.lmr_complexity_mul],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            LMR_COMPLEXITY_MUL = [self.lmr_complexity_mul, 1, 16384, 1024],
