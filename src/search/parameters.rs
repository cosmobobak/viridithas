...
use crate::{
    ...
    search::{
        ...
        NMP_IMPROVING_MARGIN, NMP_REDUCTION_EVAL_DIVISOR, NN_CORRHIST_WEIGHT,
        ...
        PAWN_HISTORY_MALUS_MAX, PAWN_HISTORY_MALUS_MUL, PAWN_HISTORY_MALUS_OFFSET,
...
impl Config {
    ...
    pub const fn default() -> Self {
        Self {
            ...
            nn_corrhist_weight: NN_CORRHIST_WEIGHT,
...
impl Config {
    ...
    pub fn ids_with_parsers(&mut self) -> Vec<(&str, LazyFieldParser<'_>)> {
        id_parser_gen![
            ...
            NN_CORRHIST_WEIGHT = [self.nn_corrhist_weight],
    ...
    pub fn base_config(&self) -> Vec<(&str, f64, f64, f64, f64)> {
        ...
        id_value_gen![
            ...
            NN_CORRHIST_WEIGHT = [self.nn_corrhist_weight, 1, 4096, 144],
