...
const REPERMUTE_INDICES: [usize; L1_SIZE / 2] = [
    631, 80, 603, 729, 166, 202, 1005, 209, 347, 770, 882, 751, 140, 479, 184, 279, 1010, 423, 229,
    596, 559, 272, 754, 546, 526, 908, 795, 266, 95, 834, 773, 207, 433, 876, 640, 117, 494, 270,
    260, 316, 417, 643, 203, 587, 469, 215, 475, 756, 101, 811, 686, 608, 154, 638, 148, 263, 129,
    780, 716, 840, 152, 565, 466, 520, 965, 857, 437, 134, 70, 116, 476, 982, 941, 24, 628, 78,
    398, 236, 845, 531, 573, 601, 870, 380, 654, 512, 932, 787, 186, 35, 616, 730, 463, 767, 462,
    689, 905, 393, 130, 295, 98, 490, 144, 509, 3, 7, 990, 313, 815, 743, 878, 304, 855, 192, 567,
    275, 1000, 193, 670, 591, 620, 682, 637, 261, 383, 335, 927, 505, 321, 842, 47, 727, 540, 998,
    90, 779, 488, 358, 200, 291, 294, 388, 752, 679, 399, 994, 653, 87, 639, 274, 852, 339, 744,
    918, 465, 600, 919, 612, 910, 340, 958, 761, 633, 736, 197, 862, 82, 835, 674, 153, 940, 64,
    696, 395, 904, 662, 415, 794, 869, 731, 288, 178, 145, 14, 973, 538, 177, 678, 514, 763, 712,
    632, 700, 655, 226, 241, 62, 137, 896, 19, 356, 271, 234, 877, 948, 378, 800, 979, 413, 171,
    550, 68, 858, 627, 584, 141, 626, 341, 175, 128, 861, 16, 991, 310, 554, 749, 10, 40, 580, 875,
    201, 547, 1014, 977, 1011, 999, 625, 249, 449, 158, 486, 54, 829, 838, 259, 71, 429, 1012, 461,
    496, 188, 684, 285, 673, 480, 77, 276, 38, 43, 775, 85, 326, 823, 660, 833, 483, 210, 162, 439,
    960, 329, 827, 1008, 322, 149, 51, 39, 728, 44, 409, 296, 693, 527, 327, 721, 492, 508, 529,
    50, 659, 595, 797, 985, 753, 100, 581, 537, 913, 29, 223, 424, 709, 120, 900, 551, 348, 422,
    119, 619, 511, 102, 585, 890, 106, 697, 614, 456, 898, 363, 11, 681, 872, 300, 113, 805, 521,
    191, 330, 988, 778, 501, 647, 20, 943, 351, 782, 658, 594, 748, 239, 575, 180, 471, 771, 243,
    915, 418, 755, 345, 962, 343, 269, 63, 374, 426, 830, 695, 956, 427, 783, 571, 707, 281, 460,
    491, 198, 928, 74, 523, 757, 734, 993, 306, 563, 235, 789, 400, 765, 318, 52, 111, 133, 856,
    443, 788, 796, 195, 945, 280, 784, 839, 308, 699, 710, 60, 1018, 963, 542, 36, 53, 802, 901,
    516, 635, 532, 826, 405, 73, 159, 983, 247, 819, 432, 412, 297, 478, 91, 115, 299, 13, 687, 75,
    698, 425, 242, 246, 641, 214, 657, 238, 497, 495, 342, 485, 574, 953, 407, 452, 385, 939, 257,
    477, 568, 588, 498, 562, 453, 196, 759, 762, 402, 888, 518, 287, 665, 664, 873, 156, 726, 808,
    914, 401, 636, 211, 864, 666, 369, 786, 715, 185, 661, 123, 593, 379, 558, 867, 34, 892, 282,
    161, 971, 885, 353, 283, 812, 813, 648, 27, 557, 493, 23, 676, 950, 435, 646, 510, 954, 337,
    714, 15, 267, 467, 273, 739, 444, 768, 703, 961, 534, 1004, 277, 828, 384, 545, 604, 968, 798,
    938, 289, 566, 692, 431, 781, 472, 947, 183, 446, 1006, 32, 163, 176, 629, 189, 851, 920, 1017,
    733, 182, 56, 769, 688, 143, 99, 874, 745, 530, 804, 396, 926, 253, 290, 883, 89, 738, 114,
    403, 387, 1022, 951, 58, 458, 135, 691, 944, 390, 227, 806, 255, 967, 720, 846, 57, 302, 451,
    377, 717, 785, 367, 410, 254, 909, 292, 957, 776, 30, 1015, 360, 832, 871, 579, 83, 12, 361,
    69, 121, 680, 790, 139, 187, 125, 92, 513, 408, 946, 109, 5, 536, 436, 899, 278, 218, 868, 411,
    1016, 774, 268, 365, 392, 887, 841, 649, 964, 96, 22, 611, 382, 535, 622, 484, 850, 324, 997,
    836, 881, 528, 981, 742, 370, 179, 41, 935, 556, 441, 980, 923, 172, 1013, 368, 419, 331, 354,
    325, 969, 931, 737, 617, 925, 110, 232, 578, 889, 541, 157, 230, 1020, 364, 107, 549, 519, 987,
    416, 18, 160, 758, 719, 6, 970, 391, 553, 936, 86, 844, 760, 642, 849, 847, 65, 564, 448, 959,
    672, 406, 824, 724, 792, 930, 533, 609, 66, 652, 897, 474, 544, 911, 181, 440, 725, 312, 860,
    447, 112, 4, 879, 216, 174, 37, 894, 543, 1009, 305, 389, 349, 615, 621, 610, 473, 359, 895,
    690, 592, 126, 79, 1007, 702, 820, 362, 831, 122, 576, 31, 912, 560, 668, 552, 208, 170, 955,
    1001, 118, 169, 434, 33, 381, 350, 859, 1, 701, 61, 891, 821, 766, 307, 645, 375, 371, 319,
    256, 397, 976, 922, 669, 708, 656, 817, 848, 386, 220, 929, 618, 706, 9, 454, 893, 865, 995,
    984, 470, 772, 589, 624, 916, 685, 801, 328, 989, 572, 515, 194, 124, 735, 903, 906, 373, 683,
    258, 104, 94, 88, 225, 252, 814, 262, 793, 503, 355, 747, 430, 204, 442, 301, 489, 921, 147,
    704, 816, 917, 634, 450, 251, 504, 303, 791, 0, 165, 597, 952, 352, 502, 978, 155, 548, 599,
    561, 445, 459, 677, 902, 105, 764, 1002, 332, 336, 250, 722, 853, 394, 45, 613, 606, 317, 222,
    651, 167, 72, 264, 675, 59, 522, 822, 807, 577, 136, 1021, 372, 539, 150, 487, 924, 173, 265,
    934, 598, 777, 933, 750, 506, 219, 630, 338, 357, 975, 344, 623, 421, 168, 464, 843, 76, 992,
    28, 376, 966, 248, 309, 942, 718, 221, 455, 334, 293, 499, 711, 732, 907, 8, 245, 884, 1019,
    972, 366, 138, 315, 886, 457, 1023, 346, 825, 500, 428, 569, 507, 525, 810, 582, 713, 49, 974,
    694, 164, 1003, 67, 55, 142, 590, 524, 586, 311, 108, 438, 644, 205, 866, 320, 21, 206, 146,
    663, 671, 217, 132, 103, 605, 996, 414, 986, 48, 25, 818, 314, 650, 741, 224, 127, 97, 481,
    482, 286, 151, 607, 583, 190, 555, 809, 240, 244, 333, 84, 705, 298, 468, 799, 837, 284, 880,
    667, 231, 17, 863, 740, 420, 81, 949, 517, 228, 2, 46, 854, 199, 803, 570, 746, 93, 602, 131,
    323, 233, 213, 237, 42, 26, 212, 723, 937, 404,
];
...
impl UnquantisedNetwork {
    ...
    fn merge(&self) -> Box<MergedNetwork> {
        ...
        for i in 0..L3_SIZE {
            for bucket in 0..OUTPUT_BUCKETS {
                net.e3_weights[i][bucket] = self.e3x_weights[i][bucket] + self.e3f_weights[i];
            }
        }
        // copy the E3 biases
        for i in 0..OUTPUT_BUCKETS {
            net.e3_biases[i] = self.e3x_biases[i] + self.e3f_biases[0];
        }
...
impl MergedNetwork {
    ...
    fn write_bullet(&self, writer: &mut impl std::io::Write) -> anyhow::Result<()> {
        ...
        dump_layer!("e3w", self.e3_weights);
        dump_layer!("e3b", self.e3_biases);
    ...
    fn quantise(&self) -> Box<QuantisedNetwork> {
        ...
        net.e3_weights = self.e3_weights;
        net.e3_biases = self.e3_biases;
...
impl QuantisedNetwork {
    ...
    fn permute(&self, use_simd: bool) -> Box<NNUEParams> {
        ...
        for bucket in 0..OUTPUT_BUCKETS {
            ...
            // transfer the E3 weights
            for i in 0..L3_SIZE {
                net.e3_weights[bucket][i] = self.e3_weights[i][bucket];
            }

            // transfer the E3 biases
            net.e3_bias[bucket] = self.e3_biases[bucket];
        }
