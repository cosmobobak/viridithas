...
struct UnquantisedNetwork {
    ...
    l2x_weights: [[[f32; L3_SIZE * 2]; OUTPUT_BUCKETS]; L2_SIZE - 1],
    l2f_weights:  [[f32; L3_SIZE * 2]; L2_SIZE - 1],
...
struct MergedNetwork {
    ...
    l1_weights: [[[f32; L2_SIZE]; OUTPUT_BUCKETS]; L1_SIZE],
    l1_biases:   [[f32; L2_SIZE]; OUTPUT_BUCKETS],
    l2_weights: [[[f32; L3_SIZE * 2]; OUTPUT_BUCKETS]; L2_SIZE - 1],
...
pub struct NNUEParams {
    ...
    pub l2_weights:  [Align64<[f32; (L2_SIZE - 1) * L3_SIZE * 2]>; OUTPUT_BUCKETS],
